 ...
 public:
  explicit VehicleStatus(Context& context)
      : Subscription<px4_msgs::msg::VehicleStatus>(
            context, "fmu/out/vehicle_status" +
   ...
   * @see navigation state values:
   * https://github.com/PX4/PX4-Autopilot/blob/v1.15.0/msg/VehicleStatus.msg#L34-L65
   */
  uint8_t navState() const { return last().nav_state; }
};
