...
TEST_F(SharedSubscriptionTest, State) {
  ...
  std::array<std::optional<SharedSubscriptionCallbackInstance>, 3> instances;
  std::array<unsigned, 3> message_counters{};

  // Single registration
  unsigned counter = 1;
  bool got_message = false;
  instances[0] = vehicle_status.registerOnUpdateCallback(
  ...
  // Add another one
  instances[1] = vehicle_status.registerOnUpdateCallback(
    [&](const px4_msgs::msg::VehicleStatus::UniquePtr & msg)
    {
      EXPECT_EQ(msg->timestamp, pub_msg.timestamp);
  ...
  // Add another one
  instances[2] = vehicle_status.registerOnUpdateCallback(
    [&](const px4_msgs::msg::VehicleStatus::UniquePtr & msg)
    {
      EXPECT_EQ(msg->timestamp, pub_msg.timestamp);
...
TEST_F(SharedSubscriptionTest, MultiInstance) {
  ...
  px4_msgs::msg::VehicleStatus pub_msg;
  std::array<std::optional<SharedSubscriptionCallbackInstance>, 2> instances;
  std::array<unsigned, 2> message_counters{};

  unsigned counter = 1;
  bool got_message = false;
  instances[0] = vehicle_status1.registerOnUpdateCallback(
    [&](const px4_msgs::msg::VehicleStatus::UniquePtr & msg)
    {
      EXPECT_EQ(msg->timestamp, pub_msg.timestamp);
      message_counters[0] = counter++;
  ...
  instances[1] = vehicle_status2.registerOnUpdateCallback(
    [&](const px4_msgs::msg::VehicleStatus::UniquePtr & msg)
    {
      EXPECT_EQ(msg->timestamp, pub_msg.timestamp);
      message_counters[1] = counter++;
...
TEST_F(SharedSubscriptionTest, MultiTypes) {
  ...
  instances[1] = vehicle_attitude.registerOnUpdateCallback(
