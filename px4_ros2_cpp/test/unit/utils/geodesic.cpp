...
TEST(Geodesic, horizontalDistanceToGlobalPosition)
{
  ...
  const float distance_res =
      px4_ros2::horizontalDistanceToGlobalPosition(global_position_start, global_position_end);
...
TEST(Geodesic, distanceToGlobalPosition)
{
  ...
  // Check against expected value
  const float distance_res =
      px4_ros2::distanceToGlobalPosition(global_position_start, global_position_end);
  EXPECT_NEAR(distance_exp, distance_res, 1e-3);
}
...
TEST(Geodesic, headingToGlobalPosition)
{
  ...
  // Check against expected value
  const float heading_res =
      px4_ros2::headingToGlobalPosition(global_position_start, global_position_end);
...
TEST(Geodesic, vectorToGlobalPosition)
{
  ...
  // Check against expected value
  const Eigen::Vector3f vector_res =
      px4_ros2::vectorToGlobalPosition(global_position_start, global_position_end);
  vectorsApproxEqualTest(vector_exp, vector_res);

  // Check resulting vector matches initial start -> end position displacement
  const Eigen::Vector3d global_position_end_new =
      px4_ros2::addVectorToGlobalPosition(global_position_start, vector_res);
...
TEST(Geodesic, globalPositionFromLineAndDist)
{
  ...
  const float dist_new =
      px4_ros2::horizontalDistanceToGlobalPosition(global_position_start, global_position_res);
...
TEST(Geodesic, globalPositionFromHeadingAndDist)
{
  ...
  // Check against expected value
  const Eigen::Vector3d global_position_res =
      px4_ros2::globalPositionFromHeadingAndDist(global_position_start, heading, dist);
  ...
  const float heading_new =
      px4_ros2::headingToGlobalPosition(global_position_start, global_position_res);
  const float dist_new =
      px4_ros2::distanceToGlobalPosition(global_position_start, global_position_res);
...
TEST(Geodesic, addVectorToGlobalPosition)
{
  ...
  // Check against expected value
  const Eigen::Vector3d global_position_res =
      px4_ros2::addVectorToGlobalPosition(global_position, vector);
  vectorsApproxEqualTest(global_position_exp, global_position_res);

  // Check resulting position displacement from the start position matches the provided vector
  const Eigen::Vector3f vector_new =
      px4_ros2::vectorToGlobalPosition(global_position, global_position_res);
